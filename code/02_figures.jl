...
plot(A, fl985, fillrange=fl015, color=:grey, alpha=0.15, label="", frame=:box, size=(400, 400),  margin=5Plots.mm,  dpi=120, legend=:topleft, foreground_color_legend=nothing, background_color_legend=:white)
